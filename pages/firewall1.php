...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Acess Firewall</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
							...
							echo "<meta HTTP-EQUIV='refresh' CONTENT='5;URL=firewall65.php'>";
							
							// caminho na rede do arquivo de monitoramento
							$mural_path = 'c:\pfirewall.log';
							$mural_rows = array_reverse( explode( PHP_EOL, file_get_contents( $mural_path ) ) );
							
							foreach( $mural_rows as $mural_row ) {
							$mural_row_item = explode( '|', $mural_row );

							$mural .= $mural_row_item[0] . '<br />' . PHP_EOL;
							$mural .= $mural_row_item[1] . '<br />' . PHP_EOL;
